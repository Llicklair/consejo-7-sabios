...
def main() -> None:
    ...
    parser.add_argument("--no-analysis", action="store_true",
                        help="Salta el mapa estructural determinista previo al "
                             "debate (P1). Por defecto SÍ se construye: un "
                             "extractor sin LLM (AST/regex) saca el esqueleto de "
                             "cada archivo a .consejo/repo-skeleton.md y alimenta "
                             "a los sabios. Es barato (sin coste LLM); úsalo solo "
                             "para saltarlo del todo.")
